            ...
            VStack {
                ...
                Group {
                    VStack {
                        HStack {
                            ...
                            Spacer()
                            DefaultTextField(placeholder: "최소 나이", text: $viewModel.editGrew.maximumMembers)
                            DefaultTextField(placeholder: "최대 나이", text: $viewModel.editGrew.maximumMembers)
                        }
                        HStack {
                            Spacer()
                            Text(grewNameErrorMessage)
                ...
                Group {
                    VStack {
                        ...
                        }, text: .constant("주소 검색"), placeholder: "주소 검색")
                        HStack {
                            Spacer()
                            Text(grewNameErrorMessage)
                                .font(.c2_L)
